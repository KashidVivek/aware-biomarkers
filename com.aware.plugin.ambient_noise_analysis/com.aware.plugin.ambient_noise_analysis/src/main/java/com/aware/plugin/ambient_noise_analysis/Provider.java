...
public class Provider extends ContentProvider {
	...
	public static final String DATABASE_NAME = "plugin_ambient_noise_analysis.db";

	public static final String[] DATABASE_TABLES = {
			"plugin_ambient_noise_analysis"
	};
	...
	public static final String[] TABLES_FIELDS = {
			AmbientNoise_Data._ID + " integer primary key autoincrement," +
					...
					AmbientNoise_Data.ANALYSIS_RESULT+ " integer default 0," +
					AmbientNoise_Data.LOWNOISETIME+" integer default 0," +
					AmbientNoise_Data.NORMALNOISETIME+" integer default 0," +
					AmbientNoise_Data.HIGHNOISETIME+" integer default 0,"+
					AmbientNoise_Data.ISHARMFULINDAG+" integer default 0,"
	...
	public static final class AmbientNoise_Data implements BaseColumns {
		...
		public static final Uri CONTENT_URI = Uri.parse("content://"+AUTHORITY+"/plugin_ambient_noise_analysis");
		...
		public static final String ANALYSIS_RESULT="anylysis_result";
		public static final String LOWNOISETIME="low_noise";
		public static final String NORMALNOISETIME="normal_noise";
		public static final String HIGHNOISETIME="high_noise";
		public static final String ISHARMFULINDAG="isharmfulinday";
	...
	public boolean onCreate() {
		...
		databaseMap.put(AmbientNoise_Data.ANALYSIS_RESULT, AmbientNoise_Data.ANALYSIS_RESULT);
		databaseMap.put(AmbientNoise_Data.LOWNOISETIME, AmbientNoise_Data.LOWNOISETIME);
		databaseMap.put(AmbientNoise_Data.NORMALNOISETIME, AmbientNoise_Data.NORMALNOISETIME);
		databaseMap.put(AmbientNoise_Data.HIGHNOISETIME, AmbientNoise_Data.HIGHNOISETIME);
		databaseMap.put(AmbientNoise_Data.ISHARMFULINDAG, AmbientNoise_Data.ISHARMFULINDAG);
		return true;
	}
