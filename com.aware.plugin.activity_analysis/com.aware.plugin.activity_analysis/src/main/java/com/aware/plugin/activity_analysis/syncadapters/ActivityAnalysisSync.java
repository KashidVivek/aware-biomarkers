package com.aware.plugin.activity_analysis.syncadapters;
...
import com.aware.plugin.activity_analysis.Provider;
 ...
 */
public class ActivityAnalysisSync extends Service {
        ...
        synchronized (sSyncAdapterLock) {
            if (sSyncAdapter == null) {
                ...
                sSyncAdapter.init(
                        ...
                        new Uri[]{
                                Provider.ActivityAnalysisData.CONTENT_URI
                        }
                );
            }
        }
